...
double getMaxMoveValue(MoveList *list); //return the maximum movevalue in the list

MoveListNode *chooseRandomNode(MoveList *list);

int countOccurances(MoveList *list, double moveValue); //count the number of instances of a moveValue in a linked list (for AI)
